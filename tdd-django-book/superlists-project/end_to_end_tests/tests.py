...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        # Alice has heard about a cool new online to-do app.
        ...
        # lists '1: Buy peacock feathers' as a to-do list item
        ...
        # The page updates again, and now shows both list items
        self.wait_for_row_in_list_table('1: Buy peacock feathers')
